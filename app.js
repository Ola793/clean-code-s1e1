...
const addButton = document.querySelector(".task__button.add");//add button
const incompleteTaskHolder = document.querySelector(".incomplete");//ul of .incomplete
const completedTasksHolder = document.querySelector(".completed");//ul of .completed
...
const createNewTaskElement = function(taskString) {
  ...
  checkBox.className = "task__input task-checkbox";
  checkBox.type = "checkbox";

    
  editInput.className="task__input task-text";
  editInput.type = "text";
